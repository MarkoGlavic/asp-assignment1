...
export class RestAPIStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: AppApiProps) {
    ...
    const moviesReviewsTable = new dynamodb.Table(this, "MovieReviewsTable", {
      ...
      sortKey: { name: "reviewerName", type: dynamodb.AttributeType.STRING }, //cant have multiple reviews for same movie otherwise
    ...
    const updateMovieReviewFn = new lambdanode.NodejsFunction(this, "UpdateMovieReview", {
      architecture: lambda.Architecture.ARM_64,
      runtime: lambda.Runtime.NODEJS_16_X,
      entry: `${__dirname}/../lambda/functionality/updateMovieReview.ts`,
      timeout: cdk.Duration.seconds(10),
      memorySize: 128,
      environment: {
        TABLE_NAME: moviesReviewsTable.tableName,
